package com.example.yunpicture.manager.auth;

import cn.hutool.core.io.resource.ResourceUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.example.yunpicture.manager.auth.model.SpaceUserAuthConfig;
import com.example.yunpicture.manager.auth.model.SpaceUserPermissionConstant;
import com.example.yunpicture.manager.auth.model.SpaceUserRole;
...
public class SpaceUserAuthManager {
    ...
    static {
        String json = ResourceUtil.readUtf8Str("D:/java/Java/Big_Projects/Yun_Picture/yun-picture/src/main/resources/biz/spaceUserAuthConfig.json");
